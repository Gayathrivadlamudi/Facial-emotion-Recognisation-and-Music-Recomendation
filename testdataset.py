...
emotion_folder = emotion_folders[label]
songs_folder = f"songs/{emotion_folder}/"

# Get a random song from the selected emotion folder
...
if songs:
    ...
    pygame.time.wait(500000)  # You can adjust the duration or remove this line
